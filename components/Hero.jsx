      ...
      <div className="max-w-screen-2xl">
        <div className="items-center justify-center flex flex-col w-full max-w-screen-2xl px-5 sm:px-10 gap-8">
          <div className="grid gap-2 justify-items-center">
            <div className="flex gap-5 items-center text-white border border-primary/40 p-1 pl-4 rounded-full">
              <p className="text-2xl font-medium">Hi I&apos;m Daniel</p>
              <span className="flex gap-5 felx-col text-nowrap bg-emerald-50/5 text-white flex-nowrap w-fit px-2 pr-3 pt-[2px] pb-[3px] items-center justify-center border border-primary-darkActive rounded-full">
