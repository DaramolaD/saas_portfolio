...
const About = () => {
  return (
    <div className="bg-bg1-normal w-full flex justify-center py-20 pb-24">
      <div className="flex flex-col px-5 max-w-screen-2xl w-full">
        <div className="head text-white">
          ...
          <p className="text-2xl lg:text-3xl lg:leading-normal italic pt-1 leading-normal">
        ...
        <div className="cta flex gap-0 items-center pt-5">
